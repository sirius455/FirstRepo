...
public class D01_ArrayList {
	...
	public static void main(String[] args) {
		...
		// - 제네릭에서는 기본형 타입을 사용할 수 없다(기본 타입의 WrapperClass 이용)
		ArrayList<String> fruits = new ArrayList<>();
		ArrayList<Integer> numbers = new ArrayList<>();
		
		// add(item): 리스트에 원하는 데이터를 순차적으로 추가한다맨 뒤에 추가한다
		fruits.add("apple");
		fruits.add("kiwi");
		fruits.add("apple");
		fruits.add("apple");
		...
		System.out.println("fruits의 크기: " + numbers.size());
