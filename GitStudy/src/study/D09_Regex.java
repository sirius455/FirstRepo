...
public class D09_Regex {
	...
	/*
	  	...
	  	# Matcher Å¬·¡½º
	  	 ...
	  	 - ÆĞÅÏ ÀÎ½ºÅÏ½º¸¦ ÀÌ¿ëÇÏ¿© ¹®ÀÚ¿­À» °Ë»çÇÒ ´ë »ç¿ëÇÏ´Â Å¬·¡½º
	...
	*/
	...
	public static void main(String[] args) {
		...
		/* 
			...
			1. abc : ÇØ´çÀÚ¸®¿¡  a ¶Ç´Â b ¶Ç´Â  c¸¦ Çô¿ë
		...
		*/  
		...
		System.out.println(Pattern.matches("s.eep", "sfeep")); //¸ğµç ¹®ÀÚ
		System.out.println(Pattern.matches("s[.]eep", "sfeep")); // .¸¸ Çã¿ë
		System.out.println(Pattern.matches("s\\.eep", "sheep")); // .¸¸ Çã¿ë
		
		System.out.println(Pattern.matches("s\\deep", "s9eep")); //¸ğµç ¼ıÀÚ
		System.out.println(Pattern.matches("\\D\\D\\D", "cat")); //¼ıÀÚ ÀÌ¿ÜÀÇ ¸ğµç°Í
		...
		System.out.println(Pattern.matches("s\\Seep", "s eep")); // °ø¹éÀ» Á¦¿ÜÇÑ ¸ğµç °Í
		...
		*/
		...
		System.out.println(Pattern.matches(regex1 , "adc.txt"));
		...
		// ÀÚ¹Ù¿¡¼­ Çã¿ëÇÏ´Â º¯¼ö¸íÀ» °Ë»çÇÒ ¼ö ÀÖ´Â Á¤±ÔÇ¥Çö½ÄÀ» ¸¸µé¾îº¸¼¼¿ä
		
		System.out.println(Pattern.matches("^[(\\w$&&\\D&&\\S][\\w_$&&\\S]*$", "$123"));	
		System.out.println(Pattern.matches("^[(\\D&&\\S&&\\w$°¡-ÆR][\\w$°¡-ÆR]*g$", "_±è±è±èg"));
		
		/* 
		  	# Pattern.compile(regex)
		  	
		  	 - Àü´ŞÇÑ Á¤±ÔÇ¥Çö½ÄÀ» ÇØ¼®ÇÏ¿© Pattren ÀÎ½ºÅÏ½º¸¦ »ı¼ºÇÏ°í ¹İÈ¯ÇÑ´Ù
