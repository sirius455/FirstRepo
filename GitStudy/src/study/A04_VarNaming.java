...
public static void main(String[] args) {
		...
		/*
		  	#우리가 변수를 사용해야 하는 이유
			1. 값을 한번에 변경할 수 있다.
				- 값을 일일이 찾아다니면서 변경할 필요가 없다.
			2. 값에 의미를 부여할 수 있다.
				- 변수의 이름을 통해서 해당 값의 용도를 쉽고 빠르게 파악할 수 있다.
		...
		/*
		  	...
		  	(4) 클래스면 첫 글자는 대문자를 사용한다
		  	
		  	(5) 프로그램 내에서 값이 변하지 않을 변수(상수) 모두 대문자를 사용한다
		  	...
		  	(4) 이미 자바에서 사용하고 있는 키워드는 변수명으로 사용할 수 없다
		  		(Eclipse에서는 이미 사용하고 있는 키워드를 보라색으로 준다)
