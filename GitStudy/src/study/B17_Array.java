...
public class B17_Array {
	...
	public static void main(String[] args) {
		...
		// 연습문제 : score의 총합과 평균(소수 둘째 자리)을 출력해 보세요.
		...
		mean = sum/(float)score.length;
			
		System.out.printf("총합 %d 평균 %.2f ",sum , mean );
		...
		int[] age = { 10, 15, 20, 18, 31 };
		boolean[] passExam = { true, false, true, false, false, 80 > 70 };
		String[] animals = new String[] { "lion", "tiger", "penguin", "monke", };
