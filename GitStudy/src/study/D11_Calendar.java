...
public class D11_Calendar {
	...
	public static void main(String[] args) {
		...
		System.out.println("1970 년 1월 1일 이후로..." + 
		...
		/* 
		  	Date
		  	 - Date 클래스 내부의 메소드들은 요즘 버전에서는 거의 업데이트가 중단되어 있다
		  	 - 시간을 계산 할때는 다른 클래스를 사용한 것을 권장한다
		...
		*/
		...
		//기능은 동작하지만 사용하는걸 추천하지 않는다! 켈린더로 대체되었기때문
...
//		}
		...
		int month = korea.get(Calendar.MONTH); // MONTH만 0에서 부터시작하기때문에 원하는 달을 하기위해선 +1 을해야한다
...
//		System.out.println("DOWIN 이번 달의 몇 번째 해당 요일인가: " + dowim);
//		
//		
