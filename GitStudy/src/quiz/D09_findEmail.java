...
public class D09_findEmail {
	...
	*/
	...
	public static void main(String[] args) {
		//System.out.println(Pattern.matches(".+[@].{1,}\\..+", "f@f.s"));
...
//		
//		String[] email = regex.split(text);
//		
//		System.out.println(Arrays.toString(email));
	
		Matcher email_matcher = Pattern.compile("[\\w]+[@].{1,}\\.(com|net|co.kr)").matcher(text);
		
		ArrayList<String> emails = new ArrayList<>();
		//Pattern regex2 = Pattern.compile("[\\w]+[@].{1,}\\.(com|net|co.kr)+");
...
//			
//			count++;
//			System.out.println("기자 email : " + email_matcher.group());
//		}
		
		System.out.println("이메일 숫자: " + count);
